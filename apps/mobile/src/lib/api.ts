// Fetch wrapper for server.getsetmvp.com/liftfuel/v1/* — JWT in Authorization header.
...
const TENANT = (Constants.expoConfig?.extra as any)?.tenant ?? 'liftfuel';
const VERSION = 'v1';

const TOKEN_KEY = 'liftfuel_access_token';
const REFRESH_KEY = 'liftfuel_refresh_token';
