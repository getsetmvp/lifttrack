...
const POINTS = [
  ...
  },
  {
    ...
    blurb:
      'Postgres on our own VM in Mumbai. No third-party SaaS holds your training or nutrition data. Daily backups; 30-day retention.',
  },
  {
    icon: Eye,
    title: 'Zero analytics SDKs, zero ads',
    blurb:
      'No Google Analytics, no Mixpanel, no Facebook Pixel. Sentry tracks crashes only — PII scrubbed, no workout or meal content.',
  },
  {
    icon: Trash2,
      ...
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-4xl font-bold tracking-tight md:text-5xl">
            Your training story stays yours.
          </h2>
          <p className="mt-4 text-lg text-muted dark:text-muted-dark">
            We built LiftTrack because fitness apps shouldn&apos;t harvest your nutrition + body data. Read the{' '}
