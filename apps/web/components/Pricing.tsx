...
const FEATURES = [
  'Unlimited workouts + meals + routines',
  'Decimal weights, drop sets, kg / lb',
  'AI meal photo macros (P / C / F + cals)',
  '7 meal slots per day with macro rings',
  'Auto rest timer + PR detection',
  'Streaks, insights, plateau radar',
  'Ask-your-data natural-language queries',
  'Body-metric tracking (weight, fat %, waist, etc.)',
  'Light + dark themes',
      ...
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted dark:text-muted-dark">
            LiftTrack is free for v1. If we add paid tiers later, the current feature set stays free forever for existing users.
          </p>
        </div>
