...
export function CTA() {
  return (
    <section className="py-24">
      <Container>
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand via-brand-deep to-accent p-10 text-white shadow-card sm:p-16">
          <div className="bg-grid absolute inset-0 opacity-10" />
          <div className="absolute -right-20 -top-20 h-72 w-72 rounded-full bg-white/15 blur-3xl" />
          <div className="absolute -bottom-32 -left-20 h-80 w-80 rounded-full bg-amber-300/20 blur-3xl" />

          <div className="relative max-w-2xl">
            <h2 className="text-4xl font-bold tracking-tight md:text-5xl">
              Stop guessing why you stalled. Start seeing.
            </h2>
            <p className="mt-4 text-lg text-white/85">
              LiftTrack is free, ad-free, and ships with one promise: your training + nutrition data stays yours. Take it for a spin today.
            </p>
